...
<!-- Mirrored from themesbrand.com/skote/layouts/auth-registerl by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jun 2022 18:58:55 GMT -->
<head>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            <h5 class="text-primary">Only Admin Register</h5>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form class="needs-validation" method="POST" action="{{ route('register_access') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="userpassword" class="form-label">Password Confirme</label>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                <p>© <script>document.write(new Date().getFullYear())</script> Skote. Crafted with <i class="mdi mdi-heart text-danger"></i> by Shorif Uddin</p>
                            </div>
                        </div>
...
<!-- Mirrored from themesbrand.com/skote/layouts/auth-register by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jun 2022 18:58:55 GMT -->
</html>
